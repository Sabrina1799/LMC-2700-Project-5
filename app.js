...
import greenDaisy from "./images/GreenDaisy.png";
...
let mappings = {
  ...
  greenDaisy: function(delay) {
    if (delay)
        this.midiSounds.playChordNow(delay, 10, [60], 2);
    else
  	...
  	return (
  	  <div className="game">
  	    ...
  	    <div className="plants">
  	      ...
  	      <img className="flower greenDaisy" id="greenDaisy" src={greenDaisy} />
